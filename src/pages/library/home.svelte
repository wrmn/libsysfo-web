<script>
  import { Page, Views, Navbar } from "framework7-svelte";
</script>

<Page name="home">
  <Navbar title="Library" />
    <p>
      kona ipsum dolor sit amet, consectetur adipisicing elit. Ullam enim quia
    ...
    <p>
      ...
      reprehenderit, fuga accusamus possimus sed, sint facilis ratione quod, qui
    ...
    <p>
      Suscipit, facere quasi atque totam. Repudiandae facilis at optio atque,
      rem nam, natus ratione cum enim voluptatem suscipit veniam! Repellat, est
    ...
    <p>
      ...
      natus ad praesentium rerum libero consectetur temporibus cupiditate atque
